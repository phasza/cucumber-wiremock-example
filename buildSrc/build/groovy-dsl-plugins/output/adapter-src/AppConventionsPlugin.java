...
/**
 * Precompiled app-conventions script plugin.
 **/
public class AppConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        assertSupportedByCurrentGradleVersion();
                target.getPluginManager().apply("common-conventions");

        try {
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_AppConventions").asSubclass(BasicScript.class);
